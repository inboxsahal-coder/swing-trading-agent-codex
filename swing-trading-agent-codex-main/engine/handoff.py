...
def write_analysis_request_markdown(context: Dict) -> str:
    ...
    lines = [
        ...
        "`entry_timing`, `reasoning`, `skip_flags`, `sector`, `themes`, `storyline_score`, `storyline_notes`",
        "",
        "Storyline/catalyst guidance (important for swing/momentum setups):",
        "- include `storyline_score` on a 0..10 scale for each candidate",
        "- include concise `storyline_notes` describing catalyst/trigger",
        "",
        "Validation rule:",
